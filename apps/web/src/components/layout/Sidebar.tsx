...
export function Sidebar() {
  return (
    <aside className="w-64 border-r border-[#1a2c4d] bg-[#0a1322] flex flex-col h-screen fixed left-0 top-0 text-slate-300 z-20">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <Link href="/" className="flex items-center gap-3 px-3 py-2.5 bg-[#111d33] text-[#00e5ff] rounded-md border border-[#1a2c4d] shadow-[0_0_10px_rgba(0,229,255,0.1)] transition-all hover:bg-[#1a2c4d]">
          <LayoutDashboard className="w-4 h-4" />
          <span className="font-medium text-sm">Dashboard</span>
        </Link>
        <Link href="/equipment" className="flex items-center gap-3 px-3 py-2.5 hover:bg-[#111d33] text-slate-400 hover:text-slate-200 rounded-md transition-colors group">
        ...
        <Link href="/checklists" className="flex items-center gap-3 px-3 py-2.5 hover:bg-[#111d33] text-slate-400 hover:text-slate-200 rounded-md transition-colors group">
        ...
        <Link href="/approvals" className="flex items-center gap-3 px-3 py-2.5 hover:bg-[#111d33] text-slate-400 hover:text-slate-200 rounded-md transition-colors group">
