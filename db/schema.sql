...
CREATE INDEX idx_diagnosis_sessions_tenant_created ON diagnosis_sessions(tenant_id, created_at);
...
CREATE INDEX idx_checklist_runs_tenant_status_updated ON checklist_runs(tenant_id, status, updated_at);
...
CREATE INDEX idx_report_drafts_tenant_status_updated ON report_drafts(tenant_id, status, updated_at);
...
CREATE INDEX idx_equipment_incidents_tenant_updated_opened ON equipment_incidents(tenant_id, updated_at, opened_at);
...
CREATE INDEX idx_equipment_incidents_severity ON equipment_incidents(tenant_id, severity);
...
CREATE INDEX idx_audit_events_tenant_event_type_created ON audit_events(tenant_id, event_type, created_at);
CREATE INDEX idx_audit_events_tenant_severity_created ON audit_events(tenant_id, severity, created_at);
CREATE INDEX idx_audit_events_tenant_resource_created ON audit_events(tenant_id, resource_type, created_at);
